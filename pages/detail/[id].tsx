...
const Detail = ({ postDetails }: IProps) => {
  ...
  return (
    ...
    >
      ...
      <div className=''>
        <div className='realtive w-[1000px] md:w-[900px] lg-[700px]'>
                ...
                <div>
                    <Link href={`/profile/${post.postedBy._id}`}>
                        <div className='mt-3 flex flex-col gap-2'>
                            ...
                            <p className='capitalize font-medium text-xs text-gray-500 sm:hidden md:block'>{post.postedBy.userName}</p>
                        </div>
                    </Link>
                </div>
              </div>
              <div className='px-10'>
                <p className='px-10 py-5 text-md text-gray-600 text-lg'>{post.caption}</p>
              </div>
