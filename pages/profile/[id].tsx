        ...
        <div className="w-full">
            <div className="flex gap-6 md:gap-10 mb-4 bg-white w-full">
                ...
                <div className="flex flex-col justify-center">
                    <p className='md:text-2xl tracking-wider flex gap-1 items-center justify-center text-md font-bold text-primary lowecase'>{user.userName.replaceAll(' ', '')}<GoVerified className='text-blue-400'/></p>
